...
def concatenate_files(prefix, begin, batch_size, total_length, args):
    ...
    for i in range(begin + batch_size, batch_size + total_length, batch_size):
...
prefix_valid = 'Generated_sentences_valid' + str(args.RL_index)

concatenate_files(prefix_train, args.train_begin, args.batch_size, args.train_sen_length, args)
concatenate_files(prefix_valid, args.valid_begin, args.batch_size, args.valid_sen_length, args)