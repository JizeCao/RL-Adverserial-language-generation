...
train = pickle.load(open('../data/save/Generated_data_beam_search_processed_1st_half.p', 'rb'))
...
cp = torch.load('/Users/TONY/Downloads/machine_learning/NLP_project/data/save/cb_model/Open_subtitles/3-3_512/best_model_checkpoint_SGD_no_valid_preprocessed.pt', map_location=lambda storage, loc: storage)
