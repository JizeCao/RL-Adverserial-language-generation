...
cp = torch.load('/Users/TONY/Downloads/machine_learning/Chatbot_train_dev/data/save/cb_model/Open_subtitles/3-3_512/best_model_checkpoint_original_setting_no_valid.pt', map_location=lambda storage, loc: storage)
voc = pickle.load(open('/Users/TONY/Downloads/machine_learning/Chatbot_train_dev/data/save/Vocabulary', 'rb'))
